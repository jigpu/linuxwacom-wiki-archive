...
of your Wacom serial device. It is assumed that you have a basic
understanding of using a console or terminal emulator within linux.
Tasks such as searching, viewing, and editing of text files will be
necessary.
...
The above examples should give you an idea of how to check and modify
the serial port values regardless of which distribution of linux you are
using. If the values are correct, matching the information given in the
BIOS, or the information printed by programs such as lspci, you can
