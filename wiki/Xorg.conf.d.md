...
[Tablet Configuration](/wiki/Tablet_Configuration "wikilink"). The use of the
"0" value to turn off a button is demonstrated.

It is anticipated that X server 1.11 will allow negative matches. That
will permit matching of the parent device.
