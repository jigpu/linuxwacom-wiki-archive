...
|      | 6    | Unknown - Should always be 0x1 when in proximity. Probably combine with next. |
...
touch and has a packet length of 22. Unfortunately, there are multiple
versions of Bamboo Touch packets.
